...
drawSprite::animation::animation(time & ft, std::vector<unsigned int>& fl, bool fbf)
{
	frames = fl;
...
MAGE_DeclareScriptingConstructor(drawSprite::animation(time, std::vector<unsigned int>, bool), "drawSpriteAnimation");
