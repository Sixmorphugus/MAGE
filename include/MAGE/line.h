...
namespace mage {
	...
	public:
		...
		bool intersects(point<T>& point) const;
		bool intersects(line<T>& point) const;
...
MAGE_DeclareScriptingType(mage::line<T>, name);\
...
MAGE_DeclareScriptingCopyOperator(mage::line<T>, name);\
